...
import { PostcommentCss, Comment_headCss, Comment_InfoCss,Comment_DateCss, Comment_bodyCss,
  Post_actionsCss, Comment_editCss, Comment_removeCss } from 'css/PostComments';
...
class PostComment extends Component {
    state = {        
      ...
      onConfirmEdit = async (comment) => {  //comment ?
                        ...
                        <Comment_headCss>
                            ...
                            {  username === currentusername && (
                                <Post_actionsCss className="actions">
                                  ...
                                  <Comment_removeCss className="remove" onClick={this.onHandleComment}>
                                    삭제
                                  </Comment_removeCss>
                                </Post_actionsCss>                               
                            )}    
